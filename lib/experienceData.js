...
const experiencesData = [
  ...
  points: [
    "Conducted regular hands-on ATL workshops for students at Jawahar Navodaya Vidyalayas (JNVs) across India.",
    "Delivered sessions on electronics, robotics, and practical STEM learning using ATL kits.",
    "Successfully conducted workshops in more than 5 JNVs as part of a Pan-India engagement.",
  ],
  location:
    "Pan-India",
},
