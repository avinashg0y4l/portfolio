...
const experiencesData = [
  {
    id: 5,
    title: "ATL Instructor",
    company_name: "CoGrad",
    icon: FaBriefcase,
    iconBg: "#EF4444",
    date: "July,2025 – Present",
    points: [
      "Working as an ATL Instructor at CoGrad, fostering innovation and technical creativity among students.",
      "Conducted regular hands-on ATL workshops for students at Jawahar Navodaya Vidyalayas (JNVs) across India (Bihar, Daman & Diu, Uttrakhand etc.).",
      "Delivered sessions on electronics, robotics, and practical STEM learning using ATL kits.",
    ],
    location:
      "Pan-India",
  },

  {
    ...
    company_name: "NIELIT Gorakhpur", // Placeholder - Replace if known
    icon: FaRobot,
